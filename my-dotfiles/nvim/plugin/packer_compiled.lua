...
_G.packer_plugins = {
  ...
  ["cloak.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/cloak.nvim",
  ...
  ["nvim-dap"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-dap",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  ["nvim-ts-rainbow2"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow2",
  ...
  ["refactoring.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/refactoring.nvim",
  ...
  ["trouble.nvim"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/trouble.nvim",
  ...
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
